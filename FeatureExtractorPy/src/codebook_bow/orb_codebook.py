...
from databasehandler import imagesHandler, orb_cb_handler
...
def extract_all_descriptors(resize_ratio, resize_method, crop_amount):
    ...
    orb_cb_handler.store_descriptors(concatDesc)
    return concatDesc
...
def build_distribution(est, n_clusters, resize_ratio, resize_method, crop_amount):
    ...
    orb_cb_handler.store_distributions(allDist)
    
    
def run_codebook(n_clusters,resize_ratio, resize_method, crop_amount):
    orb_cb_handler.drop_database_table()
    orb_cb_handler.create_database_table()
